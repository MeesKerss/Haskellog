...
alex_table = listArray (0 :: Int, 399)
  [ 0
  , 6
  , 6
  , 6
...
alex_check = listArray (0 :: Int, 399)
  [ -1
  , 9
  , 10
  , 11
...
alex_action_1 = \s -> VARNAME s
alex_action_2 = \s -> FUNNAME s
alex_action_3 = \_ -> ENDOFRULE
alex_action_4 = \_ -> VARSEP
alex_action_5 = \_ -> AND
alex_action_6 = \_ -> IF
alex_action_7 = \_ -> LPAREN
alex_action_8 = \_ -> RPAREN
alex_action_9 = \_ -> OR
