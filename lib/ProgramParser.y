...
Program
{-    :                       {Right [Rule (Fun "_and" [Var "_X",Var "_Y"]) [Var "_X",Var "_Y"],Rule (Fun "_and" [Var "_X",Var "_Y"]) [Var "_Y",Var "_X"],Rule (Var "_X") [Fun "_or" [Var "_X",Var "_Y"]],Rule (Var "_Y") [Fun "_or" [Var "_X",Var "_Y"]]]}-}
    :                       {Right []}
